#!/usr/bin/env python3
"""
Target-blind 2022 EAGLE-I outage diagnostic.
...
OUT = ROOT / "audit_outputs" / "eaglei_2022"
CACHE = ROOT / ".cache" / "eaglei_2022"
OUT.mkdir(parents=True, exist_ok=True)
CACHE.mkdir(parents=True, exist_ok=True)

EAGLE_URL = "https://ndownloader.figshare.com/files/42547897"
MCC_URL = "https://ndownloader.figshare.com/files/42547708"

EAGLE_PATH = CACHE / "eaglei_outages_2022.csv"
...
def build_candidate_windows(master: pd.DataFrame) -> pd.DataFrame:
    ...
    x = x[x["incidentBegin_dt"].dt.year == 2022].copy()
...
def main():
    ...
    view.to_csv(OUT/"eaglei_2022_fema_diagnostic.csv",index=False)
    ...
    (OUT/"eaglei_2022_summary.json").write_text(json.dumps(summary,indent=2,default=str),encoding="utf-8")
