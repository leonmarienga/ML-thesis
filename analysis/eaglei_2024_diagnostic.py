#!/usr/bin/env python3
"""
Target-blind 2024 EAGLE-I outage diagnostic.

Purpose
-------
Test whether directly observed electricity outage scale distinguishes the 2024
Helene-related FEMA outcomes, especially extreme North Carolina DR-4827 versus
lower-funded Georgia DR-4830, without using funding during matching.

All FEMA disasters beginning in calendar 2024 are enriched BEFORE funding is
...
OUT = ROOT / "audit_outputs" / "eaglei_2024"
CACHE = ROOT / ".cache" / "eaglei_2024"
OUT.mkdir(parents=True, exist_ok=True)
CACHE.mkdir(parents=True, exist_ok=True)

EAGLE_URL = "https://ndownloader.figshare.com/files/53581661"
MCC_URL = "https://ndownloader.figshare.com/files/42547708"

EAGLE_PATH = CACHE / "eaglei_outages_2024.csv"
...
def build_candidate_windows(master: pd.DataFrame) -> pd.DataFrame:
    ...
    x = x[x["incidentBegin_dt"].dt.year == 2024].copy()
...
def main():
    ...
    (OUT/"eaglei_2024_summary.json").write_text(json.dumps(summary,indent=2,default=str),encoding="utf-8")
