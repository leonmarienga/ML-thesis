...
OUT=Path("nested_five_expert_rl_referee_nonbio_results")
...
def main():
    ...
    summary={
        "purpose":"Fully nested RL referee combining five structurally different high-value routers on non-Biological high-value cases only.",
        ...
        "outer_folds":folds,
        "guardrails":[
            "Only non-Biological high-value cases are evaluated; Biological disasters are excluded from both training and evaluation.",
            ...
            "Biological cold-start cases are removed in this diagnostic so the remaining cross-hazard router can be evaluated independently."
        ]
    }
