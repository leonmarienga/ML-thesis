...
OUT = Path("multi_direction_high_router_ensemble_all_results")
...
def main():
    ...
    summary={
        "purpose":"Test complementary routing directions and voting on the full high-value dataset including Biological disasters.",
        ...
        "guardrails":[
            "Biological disasters are included in both training and evaluation; strict leave-fiscal-year-out means FY2020 Biological test cases receive no Biological high-value training support when 2020 is held out.",
            ...
            "This is the full high-router diagnostic including Biological cases; the final six-band 80%-per-band requirement remains unchanged."
        ]
    }
